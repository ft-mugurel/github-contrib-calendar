...
void makeHTTPRequest(int* count, int coordinates[MAX_COORDINATES][2]) {
  ...
  String githubUsername = readGitHubUsername();
  String getRequest = "GET /users/" + githubUsername + "/contributions?from=2025-01-01&to=2025-12-31 HTTP/1.1\r\n";
  ...
  for (int i = 0; i < *count; i++) {
    display.setPoint(coordinates[i][0], ((coordinates[i][1] - 31) * -1), true);
  }
